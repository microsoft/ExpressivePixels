...
// Uncomment the following line for Adafruit NeoPixels
...
// Uncomment the following line for 64x32 matrix
...
/***************************************************************************************/
/* This section specifies the board's GPIO to name mappings to switch triggering       */
/***************************************************************************************/
#ifdef ADAFRUIT_MATRIXPORTAL_M4_EXPRESS
#define NUM_SWITCHTRIGGER_PINS  4

SWITCHACTIVATION_GPIOBUTTON_MAPPING g_switchActivationMapping[NUM_SWITCHTRIGGER_PINS] = {
	{ "A1", PIN_A1 },
	{ "A2", PIN_A2 },
	{ "A3", PIN_A3 },
	{ "A4", PIN_A4 }
...
#else
#define NUM_SWITCHTRIGGER_PINS  0
